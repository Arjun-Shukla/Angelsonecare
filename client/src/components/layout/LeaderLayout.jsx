    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-base font-bold text-slate-800 tracking-tight">Angels One</span>
            <span className="block text-xs text-teal-600 font-semibold mt-0.5">Leader Portal</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t border-slate-100">
        ...
        <div className="flex items-center gap-3 px-1 py-2 mb-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <span className="inline-block text-xs bg-teal-50 text-teal-700 font-semibold px-1.5 py-0.5 rounded">LEADER</span>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="lg:hidden fixed top-0 inset-x-0 z-30 bg-white border-b border-slate-100 flex items-center justify-between px-4 h-14">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-bold text-slate-800">Angels One</span>
        </div>
